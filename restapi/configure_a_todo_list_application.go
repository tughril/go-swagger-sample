...
import (
	...
	"your-damain.com/swagger/restapi/operations"
	"your-damain.com/swagger/restapi/operations/todos"
)

//go:generate swagger generate server --target ../../go-swagger-sample --name ATodoListApplication --spec ../swagger.yml
